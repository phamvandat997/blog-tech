...
- [Functional interface](#heading-functional-interface)
    - [Annotation `@FunctionalInterface`](#heading-annotation-functionalinterface)
    - [Quy tắc định nghĩa functional interface](#heading-quy-tắc-định-nghĩa-functional-interface)
- [Lambda expression](#heading-lambda-expression)
    - [Cú pháp của lambda expression](#heading-cú-pháp-của-lambda-expression)
    - [Lambda expression và anonymous class](#heading-lambda-expression-và-anonymous-class)
- [Các lambda interface có sẵn của Java](#heading-các-lambda-interface-có-sẵn-của-java)
    - [`Predicate`](#heading-predicate)
    - [`Consumer`](#heading-consumer)
    - [`Function`](#heading-function)
    - [`Supplier`](#heading-supplier)
    - [`UnaryOperator`](#heading-unaryoperator)
    - [`BiPredicate`](#heading-bipredicate)
    - [`BiConsumer`](#heading-biconsumer)
    - [`BiFunction`](#heading-bifunction)
    - [`BinaryOperator`](#heading-binaryoperator)
    - [Functional interface chuyên biệt cho kiểu nguyên thuỷ](#heading-functional-interface-chuyên-biệt-cho-kiểu-nguyên-thuỷ)
- [Method reference](#heading-method-reference)
    - [Static method](#heading-static-method)
    - [Instance method của object thuộc một kiểu cụ thể](#heading-instance-method-của-object-thuộc-một-kiểu-cụ-thể)
    - [Instance method của một object có sẵn](#heading-instance-method-của-một-object-có-sẵn)
...
**1. Những phát biểu nào sau đây đúng về functional interface trong Java? (Chọn tất cả đáp án đúng.)**

**A)** Một functional interface có nhiều `abstract` method.  
**B)** Một functional interface có default method và `static` method.  
**C)** Annotation `@FunctionalInterface` là bắt buộc để khai báo một functional interface.  
**D)** Lambda expression dùng được để tạo instance của functional interface.


**2. Lambda expression nào sau đây cài đặt đúng interface `Comparator<String>`?**
...
**3. Lambda interface có sẵn nào của Java biểu diễn một hàm nhận hai đối số và tạo ra một kết quả?**
...
**5. Method reference nào sau đây thay thế đúng cho lambda expression trong đoạn mã dưới đây?**
