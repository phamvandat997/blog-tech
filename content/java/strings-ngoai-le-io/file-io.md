...
- [Khái niệm cơ bản](#heading-khái-niệm-cơ-bản)
- [Dùng Path của NIO.2](#heading-dùng-path-của-nio2)
- [Class `Files`](#heading-class-files)
- [I/O Stream](#heading-io-stream)
    - [Các class stream](#heading-các-class-stream)
    - [`FileInputStream`](#heading-fileinputstream)
    - [`FileOutputStream`](#heading-fileoutputstream)
    - [`FileReader`](#heading-filereader)
    - [`FileWriter`](#heading-filewriter)
    - [`BufferedReader`](#heading-bufferedreader)
    - [`BufferedWriter`](#heading-bufferedwriter)
    - [`ObjectInputStream` và `ObjectOutputStream`](#heading-objectinputstream-và-objectoutputstream)
    - [`PrintStream`](#heading-printstream)
    - [`PrintWriter`](#heading-printwriter)
    - [Stream chuẩn](#heading-stream-chuẩn)
- [Sao chép, di chuyển, xoá và so sánh file](#heading-sao-chép-di-chuyển-xoá-và-so-sánh-file)
- [Đọc và ghi file](#heading-đọc-và-ghi-file)
    - [Đọc file](#heading-đọc-file)
    - [Ghi file](#heading-ghi-file)
- [Làm việc với thuộc tính file](#heading-làm-việc-với-thuộc-tính-file)
- [Duyệt cây thư mục](#heading-duyệt-cây-thư-mục)
- [Serialize dữ liệu](#heading-serialize-dữ-liệu)
- [Bảng tra cứu](#heading-bảng-tra-cứu)
...
**4. Đoạn mã nào sau đây sao chép file đúng cách bằng class `Files`, đảm bảo file đích đã tồn tại sẽ bị ghi đè?**
...
**5. Đoạn mã nào sau đây đọc đúng toàn bộ các dòng từ một file vào một `List<String>` bằng `java.nio.file` API?**
...
**6. Đoạn mã nào sau đây ghi đúng một `List<String>` vào file bằng class `Files` trong Java?**
...
**7. Method nào sau đây của class `BasicFileAttributes` lấy thời điểm tạo của một file?**
...
**8. Đoạn mã nào sau đây duyệt đúng một cây thư mục bằng method `Files.walkFileTree` trong Java?**
...
**9. Đoạn mã nào sau đây serialize đúng một object vào file?**
