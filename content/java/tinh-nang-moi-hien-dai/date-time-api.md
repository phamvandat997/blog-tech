...
- [Các class Date/Time cốt lõi](#heading-các-class-datetime-cốt-lõi)
    - [Class `LocalDate`](#heading-class-localdate)
    - [Class `LocalTime`](#heading-class-localtime)
    - [Class `LocalDateTime`](#heading-class-localdatetime)
    - [Class `Instant`](#heading-class-instant)
    - [Class `Period`](#heading-class-period)
    - [Class `Duration`](#heading-class-duration)
- [Múi giờ và giờ mùa hè (Daylight Savings)](#heading-múi-giờ-và-giờ-mùa-hè-daylight-savings)
    - [Class `ZoneId` và `ZoneOffset`](#heading-class-zoneid-và-zoneoffset)
    - [Class `ZonedDateTime`](#heading-class-zoneddatetime)
    - [Giờ mùa hè (Daylight Savings)](#heading-giờ-mùa-hè-daylight-savings)
    - [Class `OffsetDateTime` và `OffsetTime`](#heading-class-offsetdatetime-và-offsettime)
- [Parsing và Formatting](#heading-parsing-và-formatting)
...
## Câu hỏi luyện tập
**1. Những cách nào sau đây là cách hợp lệ để tạo một object `LocalDate`?**
...
**2. Phương án nào sau đây là kết quả của việc thực thi dòng này?**
...
**D.** Một exception được ném ra


**3. Những giá trị `ChronoUnit` nào sau đây là hợp lệ với `LocalTime`? (Chọn tất cả phương án đúng)** 
...
**4. Những phát biểu nào sau đây là đúng? (Chọn tất cả phương án đúng)** 
...
**D.** `LocalDateTime.now()` sẽ trả về thời gian hiện tại theo múi giờ UTC


**5. Phương án nào sau đây là cách hợp lệ để lấy phần nano-giây của một object `Instant` được tham chiếu bởi `i`?**  
...
**6. Phương án nào sau đây là kết quả của việc thực thi dòng này?**
...
**7. Phương án nào sau đây là kết quả của việc thực thi dòng này?** 
...
**8. Những giá trị `ChronoField` nào sau đây là hợp lệ với `LocalDate`?** 
...
**9. Những cách nào sau đây là cách hợp lệ để tạo một object `ZoneId`?** 
...
**10. Phương án nào sau đây là kết quả của việc thực thi những dòng này?**
...
**11. Giả sử múi giờ địa phương là `+2:00`, phương án nào sau đây là kết quả của việc thực thi những dòng này?**
...
**12. Giả sử DST bắt đầu vào ngày 4 tháng 10 năm 2025 lúc 0:00:00, phương án nào sau đây là kết quả của việc thực thi những dòng trên?**
...
**13. Những phát biểu nào sau đây là đúng? (Chọn tất cả phương án đúng)**

**A.** `java.time.ZoneOffset` là subclass của `java.time.ZoneId`.  
**B.** `java.time.Instant` lấy được từ `java.time.ZonedDateTime`.  
**C.** `java.time.ZoneOffset` quản lý được DST.  
**D.** `java.time.OffsetDateTime` biểu diễn một thời điểm trong múi giờ UTC.

**14. Phương án nào sau đây là kết quả của việc thực thi những dòng này?**
...
**15. Phát biểu nào sau đây là đúng về những dòng này?**
...
**D.** Một exception được ném ra lúc runtime.
