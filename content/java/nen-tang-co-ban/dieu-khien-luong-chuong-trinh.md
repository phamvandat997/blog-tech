...
- [Câu lệnh `if`](#heading-câu-lệnh-if)
    - [Pattern matching trong câu lệnh `if`](#heading-pattern-matching-trong-câu-lệnh-if)
    - [Flow scoping (phạm vi theo luồng)](#heading-flow-scoping-phạm-vi-theo-luồng)
- [Câu lệnh `switch`](#heading-câu-lệnh-switch)
    - [Các kiểu dùng được trong `case`](#heading-các-kiểu-dùng-được-trong-case)
    - [Giá trị trong `case`](#heading-giá-trị-trong-case)
    - [Biểu thức `switch`](#heading-biểu-thức-switch)
    - [Pattern matching trong câu lệnh `switch`](#heading-pattern-matching-trong-câu-lệnh-switch)
- [Vòng lặp `while`](#heading-vòng-lặp-while)
    - [Vòng lặp lồng nhau](#heading-vòng-lặp-lồng-nhau)
    - [Câu lệnh `break` và `continue`](#heading-câu-lệnh-break-và-continue)
    - [Thêm nhãn (label)](#heading-thêm-nhãn-label)
- [Vòng lặp `for`](#heading-vòng-lặp-for)
    - [Vòng lặp `for` truyền thống](#heading-vòng-lặp-for-truyền-thống)
    - [Vòng lặp `for-each`](#heading-vòng-lặp-for-each)
    - [Vòng lặp `for` lồng nhau](#heading-vòng-lặp-for-lồng-nhau)
    - [Câu lệnh `break` và `continue`](#heading-câu-lệnh-break-và-continue-2)
    - [Thêm nhãn](#heading-thêm-nhãn)
...
**D)** Chương trình không biên dịch được  
**E)** Chương trình biên dịch được nhưng không in ra gì
...
Phương án nào sau đây dùng record pattern matching đúng cách trong câu lệnh `if` để trích và in ra tên cùng tuổi của record `Person` trong Java 21?
...
**3. Đoạn mã nào sau đây biên dịch không lỗi?**
...
Nhóm câu lệnh `case` nào sau đây hợp lệ trong Java 21 khi chèn vào biểu thức `switch`?
...
Nhóm câu lệnh `case` nào sau đây cài đặt đúng pattern matching cho cây phân cấp `Shape` khi chèn vào biểu thức `switch`?
...
**C)** `4`  
**D)** `5`  
**E)** Chương trình không biên dịch được


**9. Chương trình sau in ra gì?**
