// Client GitHub API cho trang admin trong React.
// Dùng Git Data API (blob -> tree -> commit -> ref) để mọi file của một lần đăng bài nằm gọn trong 1 commit.
...
export class GitHubRepo {
  ...
  /**
   * @param {string} path
   * @param {object} options fetch options kèm `label` mô tả bước đang làm
   */
